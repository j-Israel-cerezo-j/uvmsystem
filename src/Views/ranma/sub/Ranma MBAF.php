...
<thead>
    ...
    <th class="texto-vertical-2" style="color:white";>Id_Prog</th>
                        ...
                        <th class="texto-vertical-2" style="color:white";>Métodos_Cuantitativos_Negocios2</th>
                        <th class="texto-vertical-2" style="color:white";>Competencias_Comunicación</th>
                        <th class="texto-vertical-2" style="color:white";>Tecnicas_Comunicación_Estilo_Comunicación_Efectiva</th>
                        <th class="texto-vertical-2" style="color:white";>Tecnicas_Comunicación_Estilo_Comunicación_Efectiva2</th>
                        <th class="texto-vertical-2" style="color:white";>Información_Financiera_Administrativa</th>
                        <th class="texto-vertical-2" style="color:white";>Economia_Organización</th>
                        ...
                        <th class="texto-vertical-2" style="color:white";>Evaluación_Proyectos_Inversión</th>
                        <th class="texto-vertical-2" style="color:white";>Modelos_Econométricos</th>
                        ...
                        <th class="texto-vertical-2" style="color:white";>Administración_Riesgos</th>
                        <th class="texto-vertical-2" style="color:white"; >Acción </th> 
              </tr></thead><tbody><?php include('Conexion.php'); $con=conectar(); 
$consulta = "SELECT idprograma,cuenta,nombre,Metodos_Cuantitativos_Negocios, Métodos_Cuantitativos_Negocios2,	
Competencias_Comunicación,	Tecnicas_Comunicación_Estilo_Comunicación_Efectiva,	Tecnicas_Comunicación_Estilo_Comunicación_Efectiva2,
Información_Financiera_Administrativa, Economia_Organización, Liderazgo_Comportamiento_Organizacional,	Mercadotecnia_Estratégica,	Finanzas_Corporativas,
Administración_Estratégica_Cadena_Valor,	Evaluación_Proyectos_Inversión, Modelos_Econométricos,
Curso_Apoyo_Fundamentos_Ciencia_Datos,	Mercado_Dinero_Capitales,	Administración_Riesgos FROM PTMNFZ33F16";
...
<td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Metodos_Cuantitativos_Negocios']?>"></td>
            ...
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Tecnicas_Comunicación_Estilo_Comunicación_Efectiva']?>"></td>
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Tecnicas_Comunicación_Estilo_Comunicación_Efectiva2']?>"></td>
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Información_Financiera_Administrativa']?>"></td>
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Economia_Organización']?>"></td>
            ...
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Evaluación_Proyectos_Inversión']?>"></td>
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Modelos_Econométricos']?>"></td>
            ...
            <td ><input type="text"   size=30 style="width:25px" value="<?php echo $most['Administración_Riesgos']?>"></td>
