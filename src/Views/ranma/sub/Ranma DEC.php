...
<thead>
    ...
    <th class="texto-vertical-2" style="color:white";>Id_Prog</th>
                       ...
                       <th class="texto-vertical-2" style="color:white";>METODOS_TECNICAS_INVESTIGACION_JURIDICA </td>
                      ...
                      <th class="texto-vertical-2" style="color:white";>TECNICAS_ARGUMENTACION_PROCEDIMIENTO_ESCRITO_JUICIO_ORAL</th>
                       <th class="texto-vertical-2" style="color:white";>DERECHO_FAMILIAR_PROCEDIMIENTOS</th>
                       ...
                       <th class="texto-vertical-2" style="color:white";>OBLIGACIONES_CONTRATOS_MATERIA_CIVIL </th>
                       <th class="texto-vertical-2" style="color:white";>DERECHO_PROCESAL_CIVIL </th>
                       <th class="texto-vertical-2" style="color:white";>DERECHO_SUCESORIO</th>
  ...
  <?php
        ...
        $con=conectar(); 
        $conssl =mysqli_query($con,"SELECT idprograma,cuenta,nombre, METODOS_TECNICAS_INVESTIGACION_JURIDICA, TECNICAS_COMUNICACION_ESTILO_COMUNICACION_EFECTIVA,
        TECNICAS_ARGUMENTACION_PROCEDIMIENTO_ESCRITO_JUICIO_ORAL, DERECHO_FAMILIAR_PROCEDIMIENTOS, DERECHO_ADMINISTRATIVO_ADMINISTRACION_PUBLICA,
        DERECHO_CIVIL, OBLIGACIONES_CONTRATOS_MATERIA_CIVIL, DERECHO_PROCESAL_CIVIL, DERECHO_SUCESORIO,
        TEORIA_GENERAL_DERECHO_CONSTITUCIONAL, TRATADOS_ORGANISMOS_INTERNACIONALES, METODOS_ALTERNOS_SOLUCION_CONTROVERSIAS FROM PTMDLO33F17");
         foreach($conssl as $most){ ?>
          ...
          <tr >
            ...
            <td ><input type="text"  size=30 style="width:25px" value="<?php echo $most['DERECHO_FAMILIAR_PROCEDIMIENTOS']?>"></td>
            ...
            <td ><input type="text"  size=30 style="width:25px" value="<?php echo $most['OBLIGACIONES_CONTRATOS_MATERIA_CIVIL']?>"></td>
            <td ><input type="text"  size=30 style="width:25px" value="<?php echo $most['DERECHO_PROCESAL_CIVIL']?>"></td>
            <td ><input type="text"  size=30 style="width:25px" value="<?php echo $most['DERECHO_SUCESORIO']?>"></td>
